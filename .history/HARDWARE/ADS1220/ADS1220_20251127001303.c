...
/**
  * @brief ADS1220Init(void) ads1220��ʼ��
  * @param none
  * @retval none
  */
...
void ADS1220Config(void)
{
    ...
    /*ʹ��ר�� REFP0 �� REFN0 ����ѡ����ⲿ��׼��ѹ ͬʱ���� 50Hz �� 60Hz 500ua*/
...
/**
  * @brief int ADS1220WaitForDataReady(int Timeout)��ʼ��
  * @param none
  * @retval none
  */
...
/**
  * @brief  uint8_t SPI_Receiver_Data(void) ģʽ1
  * @param  none
  * @retval ����8λ����
  */
uint8_t SPI_Receiver_Data(void)
...
/**
  * @brief  uint8_t SPI_Receiver_Data(void) ģʽ2
  * @param  none
  * @retval ����8λ����
  */
uint8_t SPI_Receiver_Data(void)
...
/**
  * @brief  uint8_t SPI_Receiver_Data(void) ģʽ3
  * @param  none
  * @retval ����8λ����
  */
uint8_t SPI_Receiver_Data(void)
...
/**
  * @brief  void ADS1220ReadRegister(int StartAddress, int NumRegs, unsigned * pData) ���Ĵ���
  * @param  StartAddress:��ʼ��ַ 0-3 
	* @param  NumRegs �Ĵ����������3
  * @param  pData :Ҫ����������
  * @retval ����32λ����
  */
...
/**
  * @brief  void ADS1220ReadRegister(int StartAddress, int NumRegs, unsigned * pData) д�Ĵ���
  * @param  StartAddress:��ʼ��ַ 0-3 
	* @param  NumRegs �Ĵ����������3
  * @param  pData :Ҫ����������
  * @retval ����32λ����
...
/**
  * @brief  ADS1220SendResetCommand(void)��������
  * @param  none
  * @retval none
  */
...
/**
  * @brief  ADS1220SendStartCommand(void)����������ת��
  * @param  none
  * @retval none
  */
...
/**
  * @brief  ADS1220SendShutdownCommand(void)�������ģʽ 
  * @param  none
  * @retval none
  */
...
* @param  Gain:Ҫ���õķŴ��� ����ö������ ADS1220_Gain
  * @retval none
  */
