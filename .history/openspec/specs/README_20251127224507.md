...
| 规格 | 文件 | 说明 |
|------|------|------|
| [UART DMA驱动](uart-driver/spec.md) | `uart-driver/spec.md` | DMA+IDLE线检测、双缓冲、收发同步 |
| [**ModBus统一协议层**](modbus-unified/spec.md) | `modbus-unified/spec.md` | 统一ModBus RTU协议层、四串口配置 |
| [USART2显示屏通信](usart2-display-comm/spec.md) | `usart2-display-comm/spec.md` | 串口2 ModBus从站、LCD显示屏交互 |
| [USART3从机设备通信](usart3-slave-comm/spec.md) | `usart3-slave-comm/spec.md` | 串口3 ModBus主站、变频供水阀控制 |
