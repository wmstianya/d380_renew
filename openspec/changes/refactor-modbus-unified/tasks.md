...
- [ ] 1.2.1 分析 `usart2.c` 中 `Union_ModBus2_Communication()` 的寄存器处理
- [ ] 1.2.2 整理功能码03读取的寄存器地址表
  - 0x0000: 联控板主数据
  - 0x0063: 机组1数据
  - 0x0077: 机组2数据
  - ... 
  - 0x0117: 机组10数据
- [ ] 1.2.3 整理功能码10写入的寄存器地址表
- [ ] 1.2.4 文档化到 `specs/modbus-rtu/usart2-registers.md`
...
### 2.2 UART4 双角色分析
- [ ] 2.2.1 分析何时作为主机（轮询分机）
- [ ] 2.2.2 分析何时作为从机（响应联控主机）
- [ ] 2.2.3 确认主从切换机制
- [ ] 2.2.4 文档化到 `specs/modbus-rtu/uart4-role-switch.md`
